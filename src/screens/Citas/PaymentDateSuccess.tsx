...
import { BoxPackage, Cita, Product, ProductData } from "../../utils/Date.interface";
        ...
        <ViewShot ref={viewShotRef} options={{ fileName: "Payment-Receipt", format: "jpg", quality: 0.9, }}>
          ...
          >
            <View className="items-center">
              ...
              <Text className="text-white/80 text-center">
                Tu cita ha sido procesada correctamente
              </Text>
            </View>
          </LinearGradient>
          ...
          <View className="mx-6 mt-6">
            <View className="flex-row items-center mb-4">
              <MaterialIcons name="dinner-dining" size={24} color={Colors.primary} />
              <Text className="text-xl font-bold text-secondary ml-2">Detalles del Paquete</Text>
            </View>
...
export default PaymentDateSuccess;
