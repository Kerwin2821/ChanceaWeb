...
const DialogNoRegalo = ({ active, setActive, navigation }: props) => {
  const toggleDialog1 = () => {
    setActive(false);
    navigation.goBack();
  };
  ...
  return (
    ...
    >
      <Text style={[font.Bold, { textAlign: "center", fontSize: 20, paddingVertical: 10 }]}>
        ¡Tus Regalos te esperan!
      </Text>
      <Text style={[font.Regular, { textAlign: "center", fontSize: 16, paddingVertical: 10 }]}>
        Continúa explorando la pantalla inicial para encontrarlas quien te de un regalito.
      </Text>
      <View className=" mt-5">
