...
const DialogNoChats = ({ active, setActive, navigation }: props) => {
  const toggleDialog1 = () => {
    setActive(false);
    navigation.goBack();
  };
  ...
  return (
    ...
    >
      <Text style={[font.Bold, { textAlign: "center", fontSize: 20, paddingVertical: 10 }]}>
        ¡Aún no tienes chanceos!
      </Text>
      <Text style={[font.Regular, { textAlign: "center", fontSize: 16, paddingVertical: 10 }]}>
        Sigue buscando en la pantalla inicial para poder chetear con tus amigos.
      </Text>
      <View className=" mt-5">
